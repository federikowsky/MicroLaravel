...
class Sanitizer
{
     ...
     * @return array
     */
    public function arrayTrim(array $items): array
    {
     ...
     * @return int|string
     */
    public function getFilterOptions(string $type, array $filters, string $item)
    {
    ...
    public function sanitize(array $inputs, array $fields = [], bool $trim = true): array
    {
        ...
        foreach ($inputs as $key => $value) {
            ...
            if ($fieldType === 'string')
                ...
                $options = $this->getFilterOptions($fieldType, self::FILTERS, "filters");
                $flags = $this->getFilterOptions($fieldType, self::FILTERS, "flags");
